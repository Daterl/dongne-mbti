---
name: report
description: "일일 개발 리포트를 GitHub Wiki에 기록하는 스킬. 티켓이 완료되었을 때, 하루 개발이 끝났을 때, '리포트', '일일 로그', '오늘 작업 정리', '위키에 기록', 'daily log', '개발 일지', '진행 상황 기록', '오늘 뭐 했지', '작업 기록' 등의 요청 시 반드시 이 스킬을 사용한다. /report로 트리거한다."
version: "1.1"
category: workflow
---
